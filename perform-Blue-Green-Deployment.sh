...
existingApp=`curl http://ec2-34-212-100-111.us-west-2.compute.amazonaws.com:8761/eureka/apps -H "Content-Type:application/json" -H "Accept:application/json" | jq '.applications.application[] | .instance[] | select(.app == '\"$app_name\"' and .status == "UP") | "http://ec2-34-212-100-111.us-west-2.compute.amazonaws.com:8761/eureka/apps/"+.app+"/"+.instanceId+"/status?value=DOWN"' | tr -d '\"'`
